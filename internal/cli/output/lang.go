...
var en = translations{
	...
	"cli.cmd.instance":     "  instance, -i, --i    Manage Minecraft instances",
	...
	"cli.aliases":          "ALIASES:",
	"cli.alias.i":          "  -i, --i              Shortcut for 'instance' command",
...
var ru = translations{
	...
	"cli.cmd.instance":     "  instance, -i, --i    Управление инстансами Minecraft",
