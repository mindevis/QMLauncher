...
- **История команд** - стрелки ↑/↓ для навигации по предыдущим командам (или команды `!!`, `!n`)
- **Команды управления**:
  ...
  - `!n` - выполнить команду по номеру из истории
...
QMLauncher> ↑                # Предыдущая команда
QMLauncher> history          # Показать все команды
