...
[![Build](https://github.com/telecter/QMLauncher/actions/workflows/build.yml/badge.svg)](https://github.com/telecter/QMLauncher/actions/workflows/build.yml)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/telecter/QMLauncher)
[![Go Reference](https://pkg.go.dev/badge/github.com/telecter/QMLauncher.svg)](https://pkg.go.dev/github.com/telecter/QMLauncher)
...
```bash
go install github.com/telecter/QMLauncher@latest
```

### Aus Sourcecode

1. Repository klonen: `git clone https://github.com/telecter/QMLauncher`
...
```sh
QMLauncher inst create -v 1.21.8 -l fabric CoolInstance
```
...
```bash
QMLauncher search [<query>] [--kind {versions, fabric, quilt, forge}]
```
